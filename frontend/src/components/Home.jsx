...
<section className="space-y-12 pb-6">
  ...
  <section className="space-y-4">
    <div>
      <p className="text-center text-4xl font-bold uppercase tracking-[0.2em] text-cyan-700">
        Highlights
      </p>
    </div>
    ...
    <div className="relative grid gap-6 lg:grid-cols-[1.1fr,0.9fr] lg:items-center">
      <div className="space-y-3">
        ...
        <h2 className="font-display text-3xl font-bold text-slate-900">
          Lost something? We’re here to help you find it.
        </h2>
...
/* ICON COMPONENT (kept intact) */
function HighlightIcon({ icon }) {
if (icon === "intake") {
return ( <svg viewBox="0 0 24 24" className="h-7 w-7" fill="none" stroke="currentColor" strokeWidth="2"> <path d="M12 3v18" /> <path d="M3 12h18" /> <circle cx="12" cy="12" r="8" /> </svg>
)
}

if (icon === "claim") {
return ( <svg viewBox="0 0 24 24" className="h-7 w-7" fill="none" stroke="currentColor" strokeWidth="2"> <path d="M4 12l4 4 12-12" /> <circle cx="12" cy="12" r="9" /> </svg>
)
}

if (icon === "report") {
return ( <svg viewBox="0 0 24 24" className="h-7 w-7" fill="none" stroke="currentColor" strokeWidth="2"> <rect x="5" y="3" width="14" height="18" rx="2" /> <path d="M9 8h6" /> <path d="M9 12h6" /> <path d="M9 16h4" /> </svg>
)
}

return ( <svg viewBox="0 0 24 24" className="h-7 w-7" fill="none" stroke="currentColor" strokeWidth="2"> <path d="M4 12a8 8 0 0 1 13.66-5.66" /> <path d="M20 4v5h-5" /> <path d="M20 12a8 8 0 0 1-13.66 5.66" /> <path d="M4 20v-5h5" /> </svg>
)
}
